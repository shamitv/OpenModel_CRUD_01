# Phase 2-1: Backend Authentication — To-Do
...
- **Commit after completion**: `feat: add password hashing to User model`
...
- **Commit after completion**: `feat: add registration and login API endpoints`
...
- **Commit after completion**: `feat: add JWT token management`
...
- **Commit after completion**: `feat: add protected route middleware`

### C5 — Verification
- [ ] Test registration and login flows via curl
- [ ] Verify JWT tokens are issued and validated
- **Commit after completion**: `test: verify backend auth endpoints work`
