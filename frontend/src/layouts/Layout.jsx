  ...
  return (
    <div className="min-h-screen bg-canvas flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Top bar */}
        <header className="h-16 bg-surface border-b border-hairline flex items-center px-6 justify-between">
          ...
          <button
            ...
            className="bg-primary text-on-primary px-4 py-2 rounded-md text-sm font-semibold hover:bg-primary-hover transition-colors"
          >
            New Survey
          </button>
        </header>
